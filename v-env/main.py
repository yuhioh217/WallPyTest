...
def control(argv):
  if len(argv[1].split('.')) == 4:
    result = os.popen("adb connect " + argv[1]).read()
    fileList = []
    # print(result)
    if 'unable' in result:
...
if __name__ == "__main__":
  ...
  for ip in ipArr:
    ...
    print("Total Cost : " + secondToDateString(timeStrToInt(time1) + timeStrToInt(time2)))
    print("============================================")